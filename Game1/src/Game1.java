...
public class Game1 extends Applet implements Runnable, KeyListener{
	...
	public void keyPressed(KeyEvent k) { 
		...
		case KeyEvent.VK_UP:
			...
			ship.incVelX(calcAngleMoveX(ship.getMoveAngle())*0.3);
			ship.incVelY(calcAngleMoveY(ship.getMoveAngle())*0.3);
			break;
